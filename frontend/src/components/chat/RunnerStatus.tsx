...
function fallbackAuthorizeInstruction(): string {
  return "Run `coldview connector list`, choose the broker profile, then run `coldview connector authorize <profile>` from the desktop session that will hold the broker connection.";
}
