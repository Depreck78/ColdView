...
export const DOCS_DEFAULT_PAGE = "getting-started/coldview-overview";
...
export const DOCS_STRUCTURE = [
  {
    ...
    pages: [
      {
        id: "getting-started/coldview-overview",
        title: "Coldview overview",
        description: "What Coldview is, where it fits, and what boundary it keeps.",
        lead: "Coldview is an open-source finance research workspace that turns natural-language prompts into market-data pulls, backtests, reports, and reusable research context.",
        sections: [
          {
            id: "what-it-is",
            title: "What it is",
            body: `
              <p>Coldview connects an agent loop to finance tools: data loaders, strategy generation, backtest engines, document readers, trade-journal analysis, persistent memory, and multi-agent research teams.</p>
      ...
      },
      {
        ...
        title: "Quick start",
        description: "Install Coldview, initialize configuration, and run the first research task.",
        ...
        sections: [
          {
            ...
            title: "Install",
            body: `
              <pre><code>pip install coldview-ai
coldview init
coldview</code></pre>
            `
          },
          {
            ...
            title: "First run",
            body: `
              <pre><code>coldview run -p "Backtest a BTC-USDT 20/50 moving-average strategy for 2024, summarize return and drawdown, then export the report"</code></pre>
            `
          },
          {
            id: "web-ui",
            ...
            body: `
              <pre><code>coldview serve --port 8899</code></pre>
      ...
      },
      {
        ...
        lead: "Coldview keeps secrets and deployment-specific choices in environment variables or local Settings, not in source files.",
        sections: [
          {
            id: "env",
...
TIMEOUT_SECONDS=2400</code></pre>
              <p>Run <code>coldview init</code> to bootstrap the local configuration interactively.</p>
            `
          },
          {
            id: "keys",
    ...
    pages: [
      {
        ...
        description: "How a Coldview run moves from prompt to evidence.",
      ...
      },
      {
        ...
        lead: "Coldview backtests daily and minute strategies across multiple asset classes, then keeps outputs auditable with metrics and run cards.",
        sections: [
          {
            id: "engines",
            title: "Engines",
          ...
          },
          {
            ...
            title: "Example",
            body: `
              <pre><code>coldview run -p "Backtest an equal-weight SPY and BTC-USDT momentum rotation strategy for 2024 with benchmark comparison"</code></pre>
            `
          }
        ]
      },
        ...
        sections: [
          {
            ...
            title: "Presets",
            body: `
              <p>Coldview includes 30 presets such as investment committee, quant strategy desk, crypto trading desk, macro rates and FX desk, and risk committee.</p>
              <pre><code>coldview --swarm-presets
coldview --swarm-run investment_committee '{"topic":"BTC outlook"}'</code></pre>
            `
          },
          {
            id: "keys",
    ...
    pages: [
      {
        ...
        title: "Data sources",
        description: "How Coldview routes symbols and market data providers.",
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            title: "Example",
            body: `
              <pre><code>coldview --upload trades_export.csv
coldview run -p "Analyze my trading behavior, extract my shadow strategy, and compare it with my actual trades"</code></pre>
            `
          }
        ]
      },
        ...
        sections: [
          {
            ...
            title: "Library",
            body: `
              <p>Coldview bundles specialized skills across data sources, strategy generation, analysis, options, reporting, tools, and risk workflows.</p>
        ...
        sections: [
          {
            ...
            body: `
              <pre><code>coldview
coldview init
coldview run -p "your research prompt"
coldview --upload report.pdf
coldview memory list
coldview serve --port 8899
coldview-mcp</code></pre>
            `
          },
          {
            id: "interactive",
      ...
      },
      {
        ...
        title: "MCP server",
        description: "Expose Coldview tools to MCP-compatible clients.",
        lead: "The MCP server runs as a stdio subprocess and exposes Coldview tools to agent clients.",
        sections: [
          {
            id: "start",
            title: "Start",
            body: `
              <pre><code>coldview-mcp</code></pre>
            `
          },
          {
            id: "config",
        ...
        sections: [
          {
            ...
            body: `
              <ul>
                ...
                <li>Custom domain: <code>coldview.wiki</code></li>
              </ul>
            `
          },
          {
