...
const REPO = "HKUDS/Coldview";
const API = `https://api.github.com/repos/${REPO}`;
const STARS_CACHE_KEY = "coldview-github-stars";
...
function setMeta(page, version) {
  document.title = `${page.title} - Coldview Docs`;
  const description = page.description || page.lead || "Coldview documentation.";
  document.querySelector('meta[name="description"]')?.setAttribute("content", description);
  document.querySelector('meta[property="og:title"]')?.setAttribute("content", `${page.title} - Coldview Docs`);
  document.querySelector('meta[property="og:description"]')?.setAttribute("content", description);
  const canonical = `https://coldview.wiki${canonicalPath(page.id, version)}`;
