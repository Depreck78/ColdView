...
2. Use the [GitHub Security Advisory](https://github.com/HKUDS/Coldview/security/advisories/new) to report privately.
...
This policy applies to the [HKUDS/Coldview](https://github.com/HKUDS/Coldview) repository.
...
Coldview is an open-source finance **research** tool. We will **never** ask you to
...
- Our only official Discord is **https://discord.gg/6TdQnT5xcF** (the HKUDS community server,
  also linked from the README). Treat any other "Coldview" Discord as an impostor.
...
See the pinned security announcement in [Discussions](https://github.com/HKUDS/Coldview/discussions)
