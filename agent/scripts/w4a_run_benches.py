...
Output:
    ~/.coldview/reports/alpha_bench_*.html      — per-run HTML reports
    ~/.coldview/reports/bench_<zoo>_<uni>.json  — per-run raw results
    ~/.coldview/reports/bench_summary.json      — aggregate summary
...
REPORTS_DIR = Path.home() / ".coldview" / "reports"
