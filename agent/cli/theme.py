"""Centralised Rich Style table for the Coldview CLI.
...
def _is_dark_terminal(console: Console) -> bool:
    ...
    1. Explicit override via ``COLDVIEW_THEME`` env var (``dark``/``light``).
    ...
    override = get_env_config().paths.coldview_theme.strip().lower()
...
class Theme:
    ...
    Example:
        ...
        >>> get_console().print("Coldview", style=Theme.primary)
    """
