...
class TestRunnerControlEndpoints:
    ...
    def test_connector_start_message_uses_connector_status(
        ...
        assert "coldview connector status" in out
        assert "coldview live" not in out
...
# ---------------------------------------------------------------------------
# ``coldview resume <session-id>`` dispatches to the interactive loop
# ---------------------------------------------------------------------------


class TestResumeByIdDispatch:
    """``main()`` routes ``coldview resume <session-id>`` to ``_interactive_loop``."""
