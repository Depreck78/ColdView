...
_ENV_PATH = "COLDVIEW_HYPOTHESES_PATH"
...
def default_hypotheses_path() -> Path:
    ...
    Returns:
        Env override path when ``COLDVIEW_HYPOTHESES_PATH`` is set,
        otherwise ``~/.coldview/hypotheses.json``.
    """
    override = get_env_config().paths.coldview_hypotheses_path.strip()
    if override:
        return Path(override).expanduser()
    return Path.home() / ".coldview" / "hypotheses.json"
...
class Hypothesis:
    ...
    Attributes:
        ...
        skills: Relevant Coldview skills.
    ...
    def create(
        ...
        *,
        ...
        Args:
            ...
            skills: Related Coldview skills.
