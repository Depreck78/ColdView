...
|----------|--------|---------|
| `COLDVIEW_SEC_UA` | Replace the contact User-Agent with your own address | a Coldview contact string |
| `COLDVIEW_SEC_MIN_INTERVAL` | Raise the per-request spacing (never goes below the 0.12s floor) | `0.12` |
