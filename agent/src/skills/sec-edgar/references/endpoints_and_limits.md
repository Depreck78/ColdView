...
|----------|--------|---------|
| `COLDVIEW_SEC_UA` | Replace the contact User-Agent (use your own address) | a Coldview contact string |
| `COLDVIEW_SEC_MIN_INTERVAL` | Raise per-request spacing; never drops below the 0.12s floor | `0.12` |
