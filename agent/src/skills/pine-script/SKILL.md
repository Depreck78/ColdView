...
This skill exports a Coldview strategy to **all major trading platforms** in one go.
...
```pinescript
// This strategy was generated by Coldview
...
```mql5
//+------------------------------------------------------------------+
//| Generated by Coldview                                         |
//+------------------------------------------------------------------+
#property copyright "Coldview"
...
When generating code, map Coldview instrument codes appropriately:

| Coldview | TradingView | 通达信/同花顺 | MT5 |
|-------------|-------------|---------------|-----|
...
- [ ] Comment header notes the original Coldview run_id and instrument
