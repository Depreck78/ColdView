...
def run_bench(
    ...
    try:
        n_workers = get_env_config().agent_tuning.coldview_bench_workers or os.cpu_count() or 1
    except ValueError:
        logger.warning("invalid COLDVIEW_BENCH_WORKERS; falling back to sequential")
        n_workers = 1
