"""Shadow Account persistence (~/.coldview/shadow_accounts/).

Layout:
    ~/.coldview/shadow_accounts/<shadow_id>.json   ShadowProfile
    ~/.coldview/shadow_runs/<shadow_id>/           backtest run dir
    ~/.coldview/shadow_reports/<shadow_id>.pdf     rendered report
"""
