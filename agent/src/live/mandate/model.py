...
class HardCaps:
    ...
    primary guarantee. Every other field is enforced COLDVIEW-SIDE in the gate.
    ...
    Attributes:
        ...
        max_order_notional_usd: Coldview-enforced max single-order notional, USD.
        max_total_exposure_usd: Coldview-enforced cap on aggregate post-trade
            market value of all open positions, USD.
        max_leverage: Coldview-enforced gross leverage multiple. 1.0 == cash-only.
        allowed_instruments: Coldview-enforced whitelist of tradable instrument
            types. Empty == deny all (fail-closed).
        max_trades_per_day: Coldview-enforced count of order placements allowed
