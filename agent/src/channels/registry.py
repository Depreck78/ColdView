...
_INSTALL_HINTS: dict[str, str] = {
    "dingtalk": "pip install 'coldview-ai[dingtalk]'",
    "discord": "pip install 'coldview-ai[discord]'",
    "email": "No extra Python package required; configure channels.email in the agent config.",
    "feishu": "pip install 'coldview-ai[feishu]'",
    "matrix": "pip install 'coldview-ai[matrix]'",
    "mochat": "pip install 'coldview-ai[mochat]'",
    "msteams": "pip install 'coldview-ai[msteams]'",
    "napcat": "pip install 'coldview-ai[napcat]'",
    "qq": "pip install 'coldview-ai[qq]'",
    "signal": "No extra Python package required; install and run signal-cli-rest-api separately.",
    "slack": "pip install 'coldview-ai[slack]'",
    "telegram": "pip install 'coldview-ai[telegram]'",
    "wecom": "pip install 'coldview-ai[wecom]'",
    "weixin": "No extra Python package required; configure channels.weixin in the agent config.",
    "whatsapp": "pip install 'coldview-ai[whatsapp]'",
    "websocket": "pip install 'coldview-ai[channels]'",
}
    ...
    try:
        ...
        if missing:
            return ChannelAvailability(
                ...
                error=missing,
                install_hint=_INSTALL_HINTS.get(name, f"pip install 'coldview-ai[{name}]'"),
            )
...
def discover_plugins(
    ...
    for ep in entry_points(group="coldview.channels"):
