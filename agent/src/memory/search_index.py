...
Database: ~/.coldview/memory_index.db (separate from sessions.db).
"""
...
_DEFAULT_DB_PATH = Path.home() / ".coldview" / "memory_index.db"
...
class MemorySearchIndex:
    ...
    def __init__(self, db_path: Optional[Path] = None) -> None:
        ...
        Args:
            db_path: Path to SQLite DB (default: ~/.coldview/memory_index.db).
        """
