...
ROBINHOOD_AGENT_CONFIG_PATH = "~/.coldview/agent.json"
...
# Canonical seed for the operator-side ``~/.coldview/agent.json`` mcpServers
...
ROBINHOOD_MCP_SERVER_SEED: dict[str, object] = {
    ...
    "auth": {
        "type": "oauth",
        "scopes": ["trading.read"],
        "client_name": "Coldview",
        "cache_dir": "~/.coldview/live/robinhood/oauth",
    },
...
IBKR_MCP_SERVER_SEED: dict[str, object] = {
    ...
    "auth": {
        ...
        "scopes": ["mcp.read"],
        "client_name": "Coldview",
        "cache_dir": "~/.coldview/live/ibkr/oauth",
    },
    "enabled_tools": ["*"],
}
...
class MCPOAuthConfig(ConfigBase):
    ...
    client_name: str = "Coldview"
    cache_dir: str = "~/.coldview/live/robinhood/oauth"
