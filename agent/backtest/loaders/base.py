...
LOADER_CACHE_ENV = "COLDVIEW_DATA_CACHE"
LOADER_CACHE_ROOT_ENV = "COLDVIEW_DATA_CACHE_ROOT"
...
def loader_cache_enabled() -> bool:
    ...
    return get_env_config().data.coldview_data_cache
...
def loader_cache_root() -> Path:
    ...
    root = get_env_config().data.coldview_data_cache_root
    if root and root.strip():
        return Path(root).expanduser()
    return Path.home() / ".coldview" / "cache" / "loaders"
