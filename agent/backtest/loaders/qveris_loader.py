...
it reads the shared ``~/.coldview/qveris.json`` config schema, applies the
...
class QVerisClient:
    ...
    def _request(self, method: str, url: str, *, auth: bool, **kwargs: Any) -> requests.Response:
        headers = {"User-Agent": "Coldview/1.0"}
        if auth:
